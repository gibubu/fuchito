	...
	<body>
		...
		<div id="edit-equipo" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<fieldset class="form">
                    <div class="fieldcontain ${hasErrors(bean: usuario, field: 'equipo', 'error')} required">
                        <label for="username">
                            <g:message code="usuario.equipo.label" default="Equipo" />
                            <span class="required-indicator">*</span>
                        </label>
                        <g:select name="equipo.id" required="" value="${usuario?.equipo.id}" optionKey="id" optionValue="nombreCanonico" from="${equipos}" />
                    </div>
