...
<div class="fieldcontain ${hasErrors(bean: encuentro, field: 'equipo', 'error')} required">
	<label for="equipo">
		<g:message code="encuentro.equipo.label" default="Equipo" />
		<span class="required-indicator">*</span>
	</label>
	<g:select id="equipo" name="equipo.id" from="${general.Equipo.list()}" optionKey="id" required="" value="${encuentro?.equipo?.id}" class="many-to-one"/>
</div>
