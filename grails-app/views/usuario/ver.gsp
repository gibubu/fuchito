	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuario?.equipo}">
				<li class="fieldcontain">
					<span id="passwordExpired-label" class="property-label"><g:message code="usuario.equipo.label" default="Equipo" /></span>
					
						<span class="property-value" aria-labelledby="equipo-label"><g:fieldValue bean="${usuario}" field="equipo"/></span>
